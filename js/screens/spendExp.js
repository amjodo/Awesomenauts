	...
	onResetEvent: function() {	
		...
		me.game.world.addChild(new (me.Renderable.extend({
			...
			draw: function(renderer){
				...
				this.font.draw(renderer.getContext(), "F1: INCREASE GOLD PRODUCTION CURRENT STRING LEVEL: " + game.data.exp1.toString() + ((game.data.exp1 + 1) *10) , this.pos.x, this.pos.y + 100);
